...
#ifndef CONFIG_PRODUCT_REALME_SDM660 //yixue.ge@bsp.drv add for minidump feature,we need enable dload_type as minidump except agingtest and daily build
...
#else //CONFIG_PRODUCT_REALME_SDM660
	if (cmd != NULL) {
