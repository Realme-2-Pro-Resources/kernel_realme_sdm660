...
#ifndef CONFIG_PRODUCT_REALME //yixue.ge add for modem subsystem crash
...
{
#ifdef CONFIG_PRODUCT_REALME //yixue.ge modify
...
#ifndef CONFIG_PRODUCT_REALME //yixue.ge modify
